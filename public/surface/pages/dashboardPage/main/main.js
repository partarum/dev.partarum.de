...
await surveyHandler.setData("setMonth_click", (month) => {
    return {
        type: "click",
        name: "setMonth",
        topic: "dashboard",
        theme: "Survey",
        targetID: "startSurveyButton_" + month,
        doThat: async (ev) => {
            console.dir(month);

            // Zuweisung der Farben und setzen des Monats in der Datenbank
        }
    }
});
        ...
        form_startSurvey: {
            ...
            fieldset: {
                ...
                header: {
                    ...
                    h2: "Start | Stop der Monats - Erhebung"
                },
                section: {
                    _attributes: {
                        class: "prt-b2"
                    ...
                    button: [
                        {
                            _attributes: {
                                ...
                                id: "startSurveyButton_january",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Januar")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "Februar",
                                form: "formStartSurvey",
                                id: "startSurveyButton_february",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Februar")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "März",
                                form: "formStartSurvey",
                                id: "startSurveyButton_march",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("März")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "April",
                                form: "formStartSurvey",
                                id: "startSurveyButton_april",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("April")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "Mai",
                                form: "formStartSurvey",
                                id: "startSurveyButton_may",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Mai")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "Juni",
                                form: "formStartSurvey",
                                id: "startSurveyButton_june",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Juni")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "Juli",
                                form: "formStartSurvey",
                                id: "startSurveyButton_july",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Juli")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "August",
                                form: "formStartSurvey",
                                id: "startSurveyButton_august",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("August")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "September",
                                form: "formStartSurvey",
                                id: "startSurveyButton_september",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("September")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "Oktober",
                                form: "formStartSurvey",
                                id: "startSurveyButton_october",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Oktober")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "November",
                                form: "formStartSurvey",
                                id: "startSurveyButton_november",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("November")
                            }
                        },
                        {
                            _attributes: {
                                ...
                                text: "Dezember",
                                form: "formStartSurvey",
                                id: "startSurveyButton_december",
                                class: "month-button month-button--past",
                                addEvent: (await surveyHandler.getData("setMonth_click"))("Dezember")
                            }
                        },
                    ]
                },
                footer: {
                    ...
                    button_get: {
                        _attributes: {
                            class: "month-button month-button--details",
